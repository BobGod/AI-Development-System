...
class AIContentProcessor:
    ...
    def _mock_ai_response(self, messages: List[Dict]) -> str:
        ...
        system_message = messages[0]["content"] if len(messages) > 0 else ""
        
        # 检查是否是爆款文章生成请求
        if "爆款文章" in system_message or "10万+阅读" in system_message or "专业的爆款文章写手" in system_message:
            return """
